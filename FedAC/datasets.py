...
class heart(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        self.dataidxs = dataidxs
        #新
        # n = np.array(object=object)
        # t = np.array(object=object)
        # if self.dataidxs is not None:
        #     for i in dataidxs:
        #         self.data = np.load("data/heart/client_"+str(i)+"_x.npy")
        #         self.targets = np.load("data/heart/client_"+str(i)+"_y.npy")
        #         n = np.append(n, data)
        #         t = np.append(t, data)
        #     self.data = n
        #     self.targets = t
...
class sick_binary(MNIST):
    ...
    def __init__(self, root, dataidxs=None, train=True, transform=None, target_transform=None,
        ...
        if self.train:
            self.data = np.load("data/sick_binary/X_train.npy")
            self.targets = np.load("data/sick_binary/y_train.npy")
        else:
            self.data = np.load("data/sick_binary/X_test.npy")
            self.targets = np.load("data/sick_binary/y_test.npy")
