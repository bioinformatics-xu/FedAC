...
def lun(X):
    # 定义聚类数量范围
    n_clusters_range = range(2,5)#右边就是个数
...
def get_args():
    ...
    parser.add_argument('--datadir', type=str, required=False, default="./data/sick_binary", help="Data directory")
...
if __name__ == '__main__':
    ...
    if args.alg == 'FedAC':
        ...
        for round in range(args.comm_round):
            ...
            julei.fit(net_paramter)#julei.labels_  # .cluster_centers_
            label = julei.labels_
